                     ...
                     @if(Auth::guard('user')->user())
                      <li class="dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                Grupos <span class="badge"><?php echo count($grupos); ?></span> <span class="caret"></span>
                          </a>
                          <ul class="dropdown-menu" role="menu">

                            <?php
                              for ($i=0; $i < count($grupos); $i++) { 
                                echo '<li><a href="/home/group/'.$grupos[$i]->idGrupo.'">'.$grupos[$i]->name.'</a></li>';
                              }
                              if(count($grupos) == 0){
                                echo "<li><a href=''>Não há grupos criado</a></li>";
                              }
                            ?>
                          </ul>
                          <li class="dropdown">
                          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                                Tarefas <span class="badge"><?php echo count($grupos); ?></span> <span class="caret"></span>
                          </a>
                          <ul class="dropdown-menu" role="menu">
                            ...
                            <?php
                              ...
                              if(count($grupos) == 0){
                                echo "<li><a href=''>Não há tarefas criada</a></li>";
                              }
                            ?>
                          </ul>
                    @endif
